...
![Persian language pack process](https://progress-bar.dev//?title=completed)
...
```
composer require mageplaza/magento-2-persian-language-pack:dev-master mageplaza/module-smtp 
